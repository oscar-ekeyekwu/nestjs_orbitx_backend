...
export class UsersService {
  ...
  async create(
    ...
    // When called inside an active transaction, use the supplied EntityManager
    // so the row writes participate in the same transaction as the caller's
    // other writes (e.g. AuthService creating a DriverProfile alongside the
    // user during driver registration).
